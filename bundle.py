# bundle.py
#
# Builds the QwenUILib source tree (src/) into a single, plain Lua file that can
...
def build_plain_bundle(config: BundleConfig) -> str:
    ...
    bundle_code = f"""-- QwenUILib Bundled Single-File Library
...
def generate_obfuscated_loader(encoded_payload: str, seed: int, config: BundleConfig) -> str:
    ...
    # Generate Lua Code
    lua_code = f"""-- QwenUILib Obfuscated Bundle (Advanced)
