-- Obsidian UI Library (bundled build)
-- Bundled modules: 10
...
return function(UILibrary)
    ...
    local objectGenerator = custom_require("objectGenerator")
...
return function(UILibrary)
    local Utils = custom_require("utils")
    local objectGenerator = custom_require("objectGenerator")
    local EffectLib = custom_require("effects")(UILibrary)
...
modules["objectGenerator"] = function()
local objGen = {}
...
Theme.Color = {
    ...
    WindowBase   = Color3.fromRGB(15, 16, 23),   
    Rail         = Color3.fromRGB(11, 12, 18),   
    Subrail      = Color3.fromRGB(14, 15, 22),   
    Panel        = Color3.fromRGB(20, 21, 30),   
    Card         = Color3.fromRGB(26, 27, 37),   
    CardHover    = Color3.fromRGB(36, 38, 51),   
    Input        = Color3.fromRGB(30, 31, 42),   
    ...
    Border       = Color3.fromRGB(48, 50, 66),    
...
Theme.Shadow = {
    Box  = "rbxassetid://6014261993", 
    Glow = "rbxassetid://6015897843", 
...
return function(UILibrary)
    local Utils = custom_require("utils")
    local objectGenerator = custom_require("objectGenerator")
    local Draggable = custom_require("draggable")
    local EffectLib = custom_require("effects")(UILibrary)
...
custom_require("window")(UILibrary)
custom_require("category")(UILibrary)
custom_require("button")(UILibrary)
custom_require("section")(UILibrary)
